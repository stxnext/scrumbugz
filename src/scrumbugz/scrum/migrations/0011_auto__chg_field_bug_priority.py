...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('scrum_bug', 'priority', self.gf('django.db.models.fields.CharField')(max_length=20))
    ...
    models = {
        ...
        'scrum.bugzillaurl': {
            ...
            'date_synced': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 9, 29, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
